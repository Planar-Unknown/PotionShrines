...
""";
    ...
    private static final Map.Entry<Config, String> CONFIG = getConfigOrDefault("aoe_shrine", defaultConfig);
    @SuppressWarnings("unused")
    private static final Config CONFIG_DEFAULT = new TomlParser().parse(defaultConfig);
    public static final List<Config> AOE_SHRINES = CONFIG.getKey().get("Shrine");
