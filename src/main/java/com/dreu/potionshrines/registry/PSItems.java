...
import com.dreu.potionshrines.items.LootCrateBlockItem;
...
public class PSItems {
        ...
        public static final RegistryObject<Item> LOOT_CRATE = ITEMS.register("loot_crate", () -> new LootCrateBlockItem(PSBlocks.LOOT_CRATE.get(), new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
